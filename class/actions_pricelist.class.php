			...
			if ($action == 'addline') {
				...
				if (!is_int($obj)) {
					...
					if (dol_strlen($obj->cost_price)) {
						// Apply cost price from price list // Applique le prix de revient depuis le tarif
				...
				foreach ($object->lines as $line) {
					...
					if (!is_int($obj)) {
						...
						$pa = $line->pa_ht;
						if (dol_strlen($obj->cost_price)) {
							// Update the line purchase price from price list // Met à jour le prix d'achat de la ligne depuis le tarif
